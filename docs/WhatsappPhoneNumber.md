...
|**businessUsername** | **String** | Active Business Username for this phone number. The value is a plain username without &#x60;@&#x60;. |  [optional] |
...
|**updateEvent** | [**UpdateEventEnum**](#UpdateEventEnum) | Account update event that triggered this phone number status change. |  [optional] |



## Enum: UpdateEventEnum
