...
|**removedInitiatedBy** | **String** | Raw initiator from the WhatsApp Business Account deletion event. Known values include: - &#x60;USER&#x60;: The removal was initiated by the WhatsApp user. - &#x60;SYSTEM&#x60;: The removal was initiated by the Meta system.  Unknown values are returned as received. |  [optional] |
|**removedTime** | **Date** | The time when the WhatsApp Business Account deletion event was received, formatted in [RFC 3339](https://datatracker.ietf.org/doc/html/rfc3339). e.g., &#x60;2026-05-19T12:00:00.000Z&#x60;. |  [optional] |
