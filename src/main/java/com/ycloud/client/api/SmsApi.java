...
import com.ycloud.client.model.SmsPage;
...
public class SmsApi {
    ...
    private ApiResponse<SmsPage> listWithHttpInfo(Integer page, Integer limit, Boolean includeTotal, Date filterCreateTimeGte, Date filterCreateTimeLte, String filterId) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<SmsPage>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listAsync(Integer page, Integer limit, Boolean includeTotal, Date filterCreateTimeGte, Date filterCreateTimeLte, String filterId, final ApiCallback<SmsPage> _callback) throws ApiException {
    ...
    public class ApiListRequest {
         ...
         */
        public SmsPage execute() throws ApiException {
            ApiResponse<SmsPage> localVarResp = listWithHttpInfo(page, limit, includeTotal, filterCreateTimeGte, filterCreateTimeLte, filterId);
            return localVarResp.getData();
        }

        /**
         * Execute list request with HTTP info returned
         * @return ApiResponse&lt;SmsPage&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<SmsPage> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<SmsPage> _callback) throws ApiException {
    ...
    /**
     * Build call for send
     * @param smsSendRequest SMS request that needs to be sent. (required)
     ...
     */
    public okhttp3.Call sendCall(SmsSendRequest smsSendRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call sendValidateBeforeCall(SmsSendRequest smsSendRequest, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'smsSendRequest' is set
        if (smsSendRequest == null) {
            throw new ApiException("Missing the required parameter 'smsSendRequest' when calling send(Async)");
        }
        

        okhttp3.Call localVarCall = sendCall(smsSendRequest, _callback);
        return localVarCall;
     ...
     */
    public Sms send(SmsSendRequest smsSendRequest) throws ApiException {
        ApiResponse<Sms> localVarResp = sendWithHttpInfo(smsSendRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Sms> sendWithHttpInfo(SmsSendRequest smsSendRequest) throws ApiException {
        okhttp3.Call localVarCall = sendValidateBeforeCall(smsSendRequest, null);
     ...
     */
    public okhttp3.Call sendAsync(SmsSendRequest smsSendRequest, final ApiCallback<Sms> _callback) throws ApiException {

        okhttp3.Call localVarCall = sendValidateBeforeCall(smsSendRequest, _callback);
        Type localVarReturnType = new TypeToken<Sms>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
