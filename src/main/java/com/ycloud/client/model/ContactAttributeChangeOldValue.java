...
public class ContactAttributeChangeOldValue extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ContactAttributeChangeOldValue.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ContactAttributeChangeOldValue.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ContactAttributeChangeOldValue' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ContactAttributeChangeOldValue>() {
                @Override
                public void write(JsonWriter out, ContactAttributeChangeOldValue value) throws IOException {
                ...
                @Override
                public ContactAttributeChangeOldValue read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ContactAttributeChangeOldValue ret = new ContactAttributeChangeOldValue();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ContactAttributeChangeOldValue: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ContactAttributeChangeOldValue() {
        super("oneOf", Boolean.FALSE);
    }

    public ContactAttributeChangeOldValue(BigDecimal o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ContactAttributeChangeOldValue(List<String> o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ContactAttributeChangeOldValue(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ContactAttributeChangeOldValue.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactAttributeChangeOldValue
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ContactAttributeChangeOldValue with oneOf schemas: BigDecimal, List<String>, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ContactAttributeChangeOldValue given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContactAttributeChangeOldValue
  * @throws IOException if the JSON string is invalid with respect to ContactAttributeChangeOldValue
  */
  public static ContactAttributeChangeOldValue fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactAttributeChangeOldValue.class);
  }

 /**
  * Convert an instance of ContactAttributeChangeOldValue to an JSON string
  *
  * @return JSON string
  */
