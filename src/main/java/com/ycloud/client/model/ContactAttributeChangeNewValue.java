...
public class ContactAttributeChangeNewValue extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ContactAttributeChangeNewValue.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ContactAttributeChangeNewValue.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ContactAttributeChangeNewValue' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ContactAttributeChangeNewValue>() {
                @Override
                public void write(JsonWriter out, ContactAttributeChangeNewValue value) throws IOException {
                ...
                @Override
                public ContactAttributeChangeNewValue read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ContactAttributeChangeNewValue ret = new ContactAttributeChangeNewValue();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ContactAttributeChangeNewValue: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ContactAttributeChangeNewValue() {
        super("oneOf", Boolean.FALSE);
    }

    public ContactAttributeChangeNewValue(BigDecimal o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ContactAttributeChangeNewValue(List<String> o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ContactAttributeChangeNewValue(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ContactAttributeChangeNewValue.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactAttributeChangeNewValue
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ContactAttributeChangeNewValue with oneOf schemas: BigDecimal, List<String>, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ContactAttributeChangeNewValue given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContactAttributeChangeNewValue
  * @throws IOException if the JSON string is invalid with respect to ContactAttributeChangeNewValue
  */
  public static ContactAttributeChangeNewValue fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactAttributeChangeNewValue.class);
  }

 /**
  * Convert an instance of ContactAttributeChangeNewValue to an JSON string
  *
  * @return JSON string
  */
